...
def get_current_user(
    ...
    try:
        ...
        logger.exception(f"Error retrieving user with email '{current_user_email}': {err}")
        raise HTTPException(
    ...
    is_correct_password = validate_password(credentials.password, current_user.password_hash)
